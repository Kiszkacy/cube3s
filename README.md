...
- Cross-module background logic should live in predefined service files under `src/services/`, orchestrated by `src/services.py`, and each module opts in with a `SERVICES` tuple (for example `SERVICES = ("auto_brightness",)`).
